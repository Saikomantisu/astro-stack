...
Astro Stack v1.0.0 does not provide a project-update or configuration-sync command. Upgrade Astro, integrations, and application code directly in your project on the schedule that suits your team.
