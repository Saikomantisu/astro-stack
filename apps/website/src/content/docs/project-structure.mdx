...
Pages CMS adds its repository configuration and media folder without adding a package:
...
- Update `.pages.yml` when the Astro content schema and Pages CMS editor fields need to change together.
