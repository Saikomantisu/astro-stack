...
The generator creates the delivery endpoint, not a contact-form design. Add your own form in a page or component and submit `name`, `email`, and `message` to `/api/contact`.
